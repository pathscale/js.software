export default function Home() {
  return (
    <div class="max-w-4xl mx-auto">
      ...
      <p class="text-xl text-[oklch(var(--color-base-content)/0.7)] mb-8">
      ...
      <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div class="p-6 bg-[oklch(var(--color-base-200))] rounded-lg shadow-sm">
          <h2 class="text-xl font-semibold mb-2">Modern Design</h2>
          <p class="text-[oklch(var(--color-base-content)/0.7)]">
