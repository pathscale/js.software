export default function MenuShowcase() {
  return (
    <div class="max-w-4xl mx-auto space-y-6">
      <div>
        <h1 class="text-3xl font-bold mb-2">Menu Component</h1>
        <p class="text-gray-600 dark:text-gray-400">
          Placeholder for the Menu component showcase. This will be replaced with
          actual menu functionality, examples, and documentation.
        </p>
      </div>
